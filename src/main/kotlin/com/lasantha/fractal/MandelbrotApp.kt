...
//    private const val h = 1800v
    ...
    private var midPointSquare = if (fractalType == FractalType.MANDELBROT_SET)
        DoubleMatrix.toMapSquare(MapPoint(-0.75, 0.0), max(2.7 / h, 4.7 / w), subPixelCountSqrt)
    else
        DoubleMatrix.toMapSquare(MapPoint(0.0, 0.0), max(2.7 / h, 4.7 / w), subPixelCountSqrt)

    private val juliaSetCPoint = MapPoint(-0.77, 0.13)
    ...
    //   (0.437918514413838, 0.3418942276032441, 8.90491384334761E-18)
    ...
    private fun doZoomIn(x: Int, y: Int, w: Int, h: Int) {
        ...
        midPointSquare = DoubleMatrix.toMapSquare(newMidPoint, newPixelSize, subPixelCountSqrt)
        zoomFactor++
